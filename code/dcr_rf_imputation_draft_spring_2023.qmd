...
#| fig-cap: Population and sample distributions
#| fig-subcap:
#|  - X
#|  - Z
#|  - Y
...
fig_x = ff.create_distplot(
    ...
    x_list.columns, # grab the names of the dataframe columns
...
fig_z = ff.create_distplot(
    ...
    z_list.columns, # grab the names of the dataframe columns
    show_hist = False, # do not show the histogram
    show_rug = False # do not show the rugplot
)
    #* For y variable
fig_y = ff.create_distplot(
    ...
    y_list.columns, # grab the names of the dataframe columns
    show_hist = False, # do not show the histogram
    show_rug = False # do not show the rugplot
) 
...
```{python}
#| label: fig-datasets-with-missingness
#| fig-cap: Datasets with missingness
#| fig-subcap:
#|  - X
#|  - Z
#|  - Y
...
fig_x = ff.create_distplot(
    ...
    x_list.columns, # grab the column names from the dataframe
    show_hist = False, # do not show the histogram
    show_rug = False # do not show the rugplot
)
    #* for z variable
fig_z = ff.create_distplot(
    ...
    z_list.columns, # grab the column names from the dataframe
    show_hist = False, # do not show the histogram
    show_rug = False # do not show the rugplot
)
    #* for y variable
fig_y = ff.create_distplot(
    ...
    y_list.columns, # grab the column names from the dataframe
    show_hist = False, # do not show the histogram
    show_rug = False # do not show the rugplot
)
