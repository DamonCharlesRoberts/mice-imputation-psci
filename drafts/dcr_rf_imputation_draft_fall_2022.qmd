...
dbWriteTable(engine4, "benchmark", log)

# Store imputed data in database
#for (i in range(1:datasets)) {
#    df <- interpolate[[i]]
#    dbWriteTable(engine4, paste0("mean", as.character(i), sep="_"), df)
#}
#for (i in range(1:datasets)) {
#    df <- amelia[[i]]
#    dbWriteTable(engine4, paste0("amelia", as.character(i), sep="_"), df)
#}
#for (i in range(1:datasets)) {
#    df <- lmice[[i]]
#    dbWriteTable(engine4, paste0("lmice", as.character(i), sep="_"), df)
#}
#for (i in range(1:datasets)) {
#    df <- rfmice[[i]]
#    dbWriteTable(engine4, paste0("rfmice", as.character(i), sep="_"), df)
#}
#for (i in range(1:datasets)) {
#    for (m in)
#    df <- rfranger[[i]]
#    dbWriteTable(engine4, paste0("rfranger", as.character(i), sep="_"), df)
#}
```
<!--
```{r}
