...
import polars as pl
    #* user defined
from PY.helper import simulate, ampute, create_iter_table, distplot
# Seed
...
if (params$reproduce == "true") {
    ...
    procedureBoi <- c("interpolate", "amelia")

    base::Map(
        function(p,j) base::Map(
            function(d,i) DBI::dbWriteTable(
                engine3,
                paste0(
                    j
                    ,as.character(i)
    ...
    DBI::dbGetQuery(engineTest, "SHOW tables;")
